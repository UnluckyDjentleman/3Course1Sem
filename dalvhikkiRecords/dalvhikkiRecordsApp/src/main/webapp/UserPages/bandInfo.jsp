...
<%
    ...
    try {
        Bands band = new BandsDAO().getBandByBandIdUser(id);
            ...
            <table border="0">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <ul>
                                <c:forEach var="bandMem" items="${bandMembers.getMembersOfBandUser(band.band_id)}">
                                    <li>${bandMem.member_name}(${bandMem.member_instrument})</li>
                                </c:forEach>
                            </ul>
                        </td>
                    </tr>
...
<div>
    ...
    <c:forEach var="albums" items="${albumsBand.getAlbumsByBandIdUser(band.band_id)}">
        <div class="block">
            <div class="wrapper-album">
                <div class="album">
                    ...
                    <div>
                        ...
                        <h5>
                            <a href="#">${bands.getBandNameByBandIdUser(albums.band_id)}</a>
                        </h5>
