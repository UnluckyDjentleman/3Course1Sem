<%@ page import="com.example.dalvhikkirecordsapp.Objects.LikedSongs" %>
...
<%
    ...
    List<Songs>songsList=new LikedSongsDAO().getLikedSongs(id);
                ...
                <div class="element">
                    <form action="${pageContext.request.contextPath}/LikeSongServlet" method="POST">
                        <button type="submit" name="like_but" value="${songs.song_id}">
                            <input type="number"  style="display:none;" value="${idUser}" name="idUser" id="noneseen"/>
