...
<form action="${pageContext.request.contextPath}/NewUserServlet" method="POST">
    <div>
        <table border="0" style="margin:0 auto">
            ...
            <tr>
                <td style="width:5vw"><label for="email">Email</label></td>
                <td style="width:30vw"><input type="email" name="email" id="email" placeholder="Your email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"/></td>
            </tr>
            <tr>
