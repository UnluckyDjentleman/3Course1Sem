...
<head>
    ...
    <%
        ...
        try{
            songsList=new SongsDAO().getSongsByAlbumIdAdmin(albumId);
            album = new AlbumsDAO().getAlbumByAlbumIdAdmin(albumId);
...
<div>
    <div class="band_info">
        ...
        <div>
                    ...
                    <div class="block">
                        <div class="wrapper-audio">
                            <div class="element">
                                ...
                                <h5>
                                    <a href="bandInfo.jsp?bandId=${songs.band_id}">${bands.getBandNameByBandId(songs.band_id)}</a>
                                </h5>
            ...
            <form action="addSong.jsp?album_id=${album.album_id}&band_id=${album.band_id}" method="POST">
                <button type="submit" name="addSong">Add Song to Album</button>
            </form>
        </div>
    </div>
</div>
